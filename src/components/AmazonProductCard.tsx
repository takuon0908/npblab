...
export function AmazonProductCard({ product, articleSlug }: { product: AffiliateProduct; articleSlug: string }) {
  return (
    <a
      ...
      onClick={() => trackAffiliateClick("amazon", product.title, articleSlug)}
    >
