...
const TITLE_UPDATES: Record<string, string> = {
  ...
  // GSC実データ確認(2026-08-16): 「クライマックスシリーズ 2026 ルール」で754表示・CTR2.65%・順位6.1と
  // 最大の伸びしろクエリだが、タイトルが「CS」の略称のみでフルカナ表記との一致度が低かった。
  // 一方「...アドバンテージ」を含む検索はCTR31%と極めて高いため、アドバンテージは残しつつ
  // フルカナ「クライマックスシリーズ」を前方に追加する
  "rules-basics-cs-new-rule-2026": "クライマックスシリーズ(CS)新ルール「2勝」アドバンテージとは？2026年から何が変わったか",
